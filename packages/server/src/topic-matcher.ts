...
import { TOPIC_ALIASES, normalizeForAlias, lookupAlias } from './topic-aliases.js';
...
export function matchTopic(objective: string, availableTopics: string[]): MatchResult {
  ...
  for (const topic of availableTopics) {
    ...
    const topicWithoutPrefix = topic.replace(/^(js|react|math|science|html|css|git|vibe)-/, '');
